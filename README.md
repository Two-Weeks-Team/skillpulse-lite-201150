...
Busy professionals need to practice a specific skill quickly and see whether they got it right, without committing to long courses or waiting for human review.
...
```yaml
name: skillpulse-lite
services:
  - name: api
    github:
      repo: Two-Weeks-Team/skillpulse-lite
      branch: master
